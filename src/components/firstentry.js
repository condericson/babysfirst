...
class FirstEntry extends Component {
  ...
  render() {
    ...
    if (this.props.errorMessage) {
      errMessage = (
        <p className="firstEntryOops">
          Oops! Something went wrong. Try checking your picture's url.
        </p>
      );
    }
    return (
        ...
        <div className="firstEntryForm_container">
          <form className="firstEntryForm" onSubmit={this.submitForm}>
            ...
            <div className="imageUploadEntry">
              <p className="imageP">
                Upload a picture of the moment! (optional)
              </p>
              <input
                className="firstEntryImage"
